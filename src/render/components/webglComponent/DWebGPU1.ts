...
import TriangleVertexShaderCode from "./wgsl/demo1Vertex.wgsl?raw"
import TriangleFramentShaderCode from "./wgsl/demo1Fragment.wgsl?raw"
...
class DWebGPU1 {
    ...
    constructor(backgroundColor: GPUColor) {
    ...
    initPipelineMulti() {
                ...
                buffers: [
                    {
                        ...
                        stepMode: "vertex" // 如果值为instance则每个顶点的值相同
                    }
                ],
            },
            fragment: {
        ...
        this.renderPipeline = device.createRenderPipeline(pipelineDesc)
     ...
     * @param vertex  顶点坐标
     * @param colorArray 片元数据
     * @param index  顶点绘制顺序
     * @param mxArray 转换矩阵
     */
    initGPUBufferMulti(vertex: Float32Array, colorArray: Float32Array, mxArray: Float32Array, index?: Uint32Array) {
